...
class ViewController: UIViewController,
  ...
  private func raceKartsWithRandomizedSpeed() {
    // YOUR CODE HERE
      let kart0RandomSpeed = Double.random(in: 0.5...5)
      translate(kart: kartView0, by: view.frame.width,animationDuration: kart0RandomSpeed)
      let kart1RandomSpeed = Double.random(in: 0.5...5)
      translate(kart: kartView1, by: view.frame.width,animationDuration: kart1RandomSpeed)
      let kart2RandomSpeed = Double.random(in: 0.5...5)
      translate(kart: kartView2, by: view.frame.width,animationDuration: kart2RandomSpeed)
  }
}
